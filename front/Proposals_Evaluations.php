    ...
    $file=$_FILES["file"];
      ...
      if(in_array($fileActualExt,$allowed)){
         ...
         if($fileSize < 1000000){
          ...
          //------------------------------------
          $req=$bdd->query("insert into list (id,proposal,description,status,acter) values ('".$_SESSION['id']."','".$fileName."','".$fileDestination."','statut1','acter1')");
...
<!-------------------------------------------------------->
  ...
  <table>
    ...
    <tbody>
      <?php
          $req=$bdd->query("select * from list where id='".$_SESSION['id']."'");
          while($row=$req->fetch()){ 
